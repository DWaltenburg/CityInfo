        ...
        <div>
            ...
            <div className="container mt-4">
                <div className="row">
                    ...
                    <div className="col-md-4 my-2">
                        <Card title="Cities" link="/Cities" image_src={ city_logo } image_placement="top" image_alt="Picture of a city"/>
                    </div>
                    <div className="col-md-4 my-2">
                        <Card title="Languages" link="/Languages" image_src={ language_logo }/>
                    </div>
                    <div className="col-md-4 my-2">
                        <Card title="Countries" link="/Countries" image_src={ country_logo } image_placement="top" image_alt="Picture of a city"/>
                    </div>
                </div>
            </div>
        </div>
